...
CTMC models do not admit a standard per-observation log-likelihood decomposition — the CTMC likelihood is defined over the joint tip configuration, not individual languages — so LOO is not applicable to them.
